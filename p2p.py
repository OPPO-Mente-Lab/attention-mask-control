...
def cv2ImgAddText(img, text, left, top, textColor=(0, 255, 0), textSize=20):
    ...
    fontText = ImageFont.truetype(
        "../models/font.ttf", textSize, encoding="utf-8")
...
def view_images(images, num_rows=1, offset_ratio=0.02, save_img=True):
...
def show_cross_attention(prompts, tokenizer, attention_store: AttentionStore, res: int, from_where: List[str], select: int = 0, save_img: bool = True):
